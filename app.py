...
<div style="text-align:center; margin-bottom:30px;">
    <h1>🛒 SmartShop Assistant</h1>
    <p style="color:#9CA3AF;">
        Trouvez, comparez et achetez vos produits avec l’aide de l’IA
    </p>
</div>
...
if not st.session_state.photo_mode and not st.session_state.agent_mode:
    user_input = st.chat_input("Ex : chaussures homme cuir, sac élégant, montre…")
else:
    user_input = None
#st.camera_input("ajouter une photo")
...
if st.session_state.agent_mode:
    ...
    st.markdown(
        "[📲 Contacter sur WhatsApp](https://wa.me/221XXXXXXXXX)",
        unsafe_allow_html=True
    )